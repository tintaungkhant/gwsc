        ...
        <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                <div class="overflow-hidden p-4 shadow ring-1 ring-black ring-opacity-5 sm:rounded-lg">
                    <form action="<?php echo route("admin/available-sites/store") ?>" method="POST">
                        <div class="mb-3">
                            ...
                            <div class="mt-2">
                                <select name="SiteID" id="SiteID" class="input-box">
                                    ...
                                    <option value="<?php echo $site["SiteID"] ?>"><?php echo $site["SiteName"] ?>
                                    </option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        ...
                        <div class="mb-3">
                            <label for="PitchTypeID" class="block text-sm font-medium leading-6 text-gray-900">Pitch
                                Type</label>
                            <div class="mt-2">
                                <select name="PitchTypeID" id="PitchTypeID" class="input-box">
                                    <?php foreach ($pitch_types as $pitch_type) : ?>
                                    <option value="<?php echo $pitch_type["PitchTypeID"] ?>">
                                        <?php echo $pitch_type["PitchTypeName"] ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            <label for="Fee" class="block text-sm font-medium leading-6 text-gray-900">Fee per
                                person</label>
                            <div class="mt-2">

                    ...
                    <form action="/admin/available-sites/store" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mt-2">
                                <div class="relative flex items-start">
                                    <div class="flex h-6 items-center">
                                        <input id="local_attraction_1" value="1" checked name="IsAvailabe" type="radio" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-600">
                                    </div>
                            ...
                            <div class="mt-2">
                                <div class="relative flex items-start">
                                    <div class="flex h-6 items-center">
                                        <input id="local_attraction_2" value="0" name="IsAvailabe" type="radio" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-600">
                                    </div>
                                    <div class="ml-3 text-sm leading-6">

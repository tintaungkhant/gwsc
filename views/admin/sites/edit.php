                ...
                <div class="overflow-hidden p-4 shadow ring-1 ring-black ring-opacity-5 sm:rounded-lg">
                    <form action="/admin/sites/<?php echo $site["SiteID"] ?>/update" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="mt-2">
                                <textarea rows="4" name="SiteLocation" id="SiteLocation" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"><?php echo $site["SiteLocation"] ?></textarea>
                            </div>
                        </div>
                        <div class="mb-3">

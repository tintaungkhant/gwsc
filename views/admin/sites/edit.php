        ...
        <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                <div class="overflow-hidden p-4 shadow ring-1 ring-black ring-opacity-5 sm:rounded-lg">
                    <form action="<?php echo route("admin/sites/" . $site["SiteID"] . "/update") ?>" method="POST" enctype="multipart/form-data">
                        <div class="mb-3">
                            <label for="SiteName" class="block text-sm font-medium leading-6 text-gray-900">Name</label>
                            <div class="mt-2">
                                <input type="text" name="SiteName" id="SiteName" value="<?php echo $site["SiteName"] ?>" class="input-box">
                            </div>
                        </div>
                        <div>
                            <label for="SiteDescription" class="block text-sm font-medium leading-6 text-gray-900">Description</label>
                            <div class="mt-2">
                                <textarea rows="4" name="SiteDescription" id="SiteDescription" class="input-box"><?php echo $site["SiteDescription"] ?></textarea>
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="SiteLocation" class="block text-sm font-medium leading-6 text-gray-900">Location</label>
                            <div class="mt-2">
                                <textarea rows="4" name="SiteLocation" id="SiteLocation" class="input-box"><?php echo $site["SiteLocation"] ?></textarea>
                            </div>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <button class="btn-default">Update Site</button>
                        </div>
                    </form>
                </div>
            </div>

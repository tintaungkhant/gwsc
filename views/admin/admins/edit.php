                ...
                <div class="overflow-hidden p-4 shadow ring-1 ring-black ring-opacity-5 sm:rounded-lg">
                    <form action="/admin/admins/<?php echo $admin["AdminID"] ?>/update" method="POST">
                        <div class="mb-3">
                            ...
                            <div class="mt-2">
                                <input type="text" name="AdminUsername" id="AdminUsername" value="<?php echo $admin["AdminUsername"] ?>" class="input-box">
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="AdminPassword" class="block text-sm font-medium leading-6 text-gray-900">Password</label>
                            <div class="mt-2">
                                <input type="password" name="AdminPassword" id="AdminPassword" value="" class="input-box">
                            </div>
                        </div>
                        <div class="mb-3">
                            <button class="btn-default">Update Admin</button>
                        </div>
                    </form>
                </div>
            </div>
